<dialog class="search-filters" id="searchFilters">
    ...
    <form class="search-filters__form">
                ...
                <fieldset class="search-filters__field field">
                    ...
                    <div class="search-filters__field-row field__row">
                        ...
                        <label class="search-filters__field-input field__input button">All types
                            <input type="radio" name="property-type" class="field__input--radio" required>
                        </label>
                    </div>
                </fieldset>
            </div>
            ...
            <div class="search-filters__fieldset-row field__fieldset-row">
                <fieldset class="search-filters__field field">
                    ...
                    <div class="search-filters__field-row field__row">
                        ...
                        <label class="search-filters__field-input field__input button">All types
                            <input type="radio" name="offer-type" class="field__input--radio" required>
                        </label>
                    </div>
                </fieldset>
                <fieldset class="search-filters__field field">
                    ...
                    <div class="search-filters__field-row field__row">
                        <select class="search-filters__field-input field__input field__input--select" name="district" id="search-filters-district" required>
        ...
        <div class="search-filters__buttons-container">
            <button class="search-filters__button--ghost search-filters__button button--ghost button">Reset filters</button>
