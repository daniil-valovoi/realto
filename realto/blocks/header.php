    ...
    <header class="header">
        <div class="header__inner container">
            ...
            <nav class="header__menu visible-desktop">
                <ul class="header__menu-list">
                    <li class="header__menu-item">
                        <a href="/realto/pages/search-results.php?offer-type=buy" class="header__menu-link">Buy</a>
                    </li>
                    <li class="header__menu-item">
                    ...
                    <li class="header__menu-item header__menu-item--dropdown">
                        <a href="#" class="header__menu-link">Rent 
                            <svg class="header__menu-link--dropdown-icon chevron-icon" width="11" height="7" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="header__menu-list header__menu-list--dropdown">
                            <li class="header__menu-item">
                                <a href="/realto/pages/search-results.php?offer-type=rent" class="header__menu-link">Find a rental</a>
                            </li>
                            <li class="header__menu-item">
            ...
            <nav class="header__menu">
                <ul class="header__menu-list">
                    <li class="header__menu-item">
                        <button class="header__menu-link link restricted-content--not-auth sign-in-button" onclick="signInPopup.showModal()">Sign in</button>
                    ...
                    <li class="header__menu-item  hidden-desktop">
                        <button class="header__burger-button burger-button" 
                        type="button" onclick="mobileOverlay.showModal()">
