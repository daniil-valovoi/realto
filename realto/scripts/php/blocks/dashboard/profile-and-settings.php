...
if ($action === 'general-information') {
    try {
        ...
        $newProfilePicture = $validator->validateFile('profile picture', $_FILES['new-profile-picture'], null, 10);
        ...
        if ($newProfilePicture) {
            ...
            $_SESSION['profile_picture'] = '/realto/images/user-images/profile-pictures/' . $newProfilePictureName;
        }
