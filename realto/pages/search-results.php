...
<header class="search-results__form-header header">
    <div class="search-results__form-header-inner header__inner container">
        <form class="search-results__form search-form hidden-mobile" id='search-results-filters-quick-form'>
            ...
            <select name="offer-type" id="search-results__form-listing-type" class="search-results__form-input field__input ">
    ...
    <section class="section container">
        <div class="section__header">
            <div class="search-results__header">
                <h1 class="search-results__title">Apply filters to see offers</h1>
                <!--
